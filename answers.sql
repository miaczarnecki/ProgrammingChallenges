...
--Based on conversions, Friday is the best day of the week to run ads. This bonus was a tough one! Becasue of some formatting issues I was stuggling with both the "servdate" and "dayname" functions, so I ended up writing a simple query and using the text funtion on excel to convert the dates. 
